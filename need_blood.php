...
if(!$connection){
    ...
    if(isset($_POST["submit"])){
        ...
        $sql = "INSERT INTO requestor (fullname,mobileno,emailid,age,gender,blood,address)
        VALUES ('$fullname', '$mobileno', '$emailid', '$age', '$gender', '$blood_group', '$address')";

        // sending to database 
        if (mysqli_query($connection, $sql)){
            echo "Your request has been submitted. We will contact you on your phone number.";
        }else {
